...
[**Handy Snippets**](https://handy.foxtrot-stash.ru) - [Vite](https://vitejs.dev) + Typescript app for storing and sharing end-to-end encrypted notes online. This app uses [**GraphQL**](https://graphql.org/) API to interact with [**Handy Snippets Backend**](https://github.com/dariasmyr/handy-snippets-backend)
